...
import nyt.assassment.nytapp.WebService.RetroClientService;
...
public class HomeInteractorImpl implements HomeInteractor {
    @Override
    public void getArticleDetails(int period, String key, final HomeListner homeListner) {
        RetroClientService.getService().getArticleDetails(period,key).enqueue(new Callback<JsonObject>() {
            @Override
