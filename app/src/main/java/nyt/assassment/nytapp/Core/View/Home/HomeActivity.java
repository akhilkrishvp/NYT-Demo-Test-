package nyt.assassment.nytapp.Core.View.Home;
...
import nyt.assassment.nytapp.Core.Adapter.ArticleListAdapter;
...
import nyt.assassment.nytapp.Helper.MyApplication;
import nyt.assassment.nytapp.R;
   ...
   //     searchView.setSuggestions(getResources().getStringArray(R.array.query_suggestions));
    ...
    public void getArticleDetails(){
        if(isNetworkAvailable()){
            ...
            homePresenter.getArticleDetails(Constants.PERIOD,Constants.API_KEY);
        }
    }
    @Override
